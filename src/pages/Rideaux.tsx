...
export default function Rideaux() {
  return (
    <CategoryPage
      ...
      heroImage={`${import.meta.env.BASE_URL}rideaux-hero.jpg`}
      galleryDraws={[
      ...
      extraContent={
        <div>
          ...
          <RealisationsSection
            firstPhoto={`${import.meta.env.BASE_URL}naunces-177.jpg`}
            firstVideo={`${import.meta.env.BASE_URL}IMG_1186.MOV`}
          />
        </div>
      }
    />
