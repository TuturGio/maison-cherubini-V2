        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="px-8 py-14 md:px-16 md:py-20 flex flex-col justify-center space-y-8 border-r border-[var(--pale)]">
            <div className="flex gap-4">
              ...
              <div>
                <p className="font-['Lato'] font-light text-[10px] tracking-[2px] uppercase text-[var(--primary)] mb-2">
                  Adresse
                </p>
            ...
            <div className="bg-[var(--linen)] p-6">
              <p className="font-['Lato'] font-light text-[10px] tracking-[2px] uppercase text-[var(--primary)] mb-3">
                Bon à savoir
              </p>
              ...
              <Link
                to="/contact"
                className="inline-block mt-5 font-['Lato'] font-light text-[9px] tracking-[3px] uppercase text-[var(--moka)] border-b border-[var(--primary)] pb-[3px] no-underline transition-colors hover:text-[var(--primary)]"
              >
                Prendre rendez-vous
              </Link>
            </div>
